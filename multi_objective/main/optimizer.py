...
class BaseOptimizer:
    ...
    def optimize(self, config, seed=0, project="test"):
        ...
        random.seed(seed)
        self.seed = seed 
        self.oracle.task_label = "neural_" + str(self.args.max_obj) + '_' + str(self.args.min_obj) + str(seed)
        self._optimize(config)
        if self.args.log_results:
            self.log_result()
        self.save_result("neural_" + str(self.args.max_obj) + '_' + str(self.args.min_obj) + str(seed))
        self.reset()
