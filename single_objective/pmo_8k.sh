...
do
# echo $oralce
taskset -c 12-23 python run.py ngo --oracles $oralce --seed $seed --run_name reinvent_8k --config_default hparams_8k.yaml --wandb online 
done
done
...
do
# echo $oralce
taskset -c 12-23 python run.py ngo --oracles $oralce --seed $seed --run_name molga_reinvent_8k --config_default hparams_molga_8k.yaml --wandb online 
done
done
