...
do
# echo $oralce
taskset -c 36-47 python run.py ngo --oracles $oralce --seed $seed --run_name reinvent_5k --config_default hparams_5k.yaml --wandb online 
done
done
...
do
# echo $oralce
taskset -c 36-47 python run.py ngo --oracles $oralce --seed $seed --run_name molga_reinvent_5k --config_default hparams_molga_5k.yaml --wandb online 
done
done