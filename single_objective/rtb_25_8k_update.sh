...
do
# echo $oralce
CUDA_VISIBLE_DEVICES=2 python run.py ngo_gfn --oracles $oralce --seed $seed --run_name rtb_beta25_8k+update --config_default hparams_beta_8k_update.yaml --wandb online 
done
done
