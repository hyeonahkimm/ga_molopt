...
do
# echo $oralce
taskset -c 0-11 python run.py ngo --oracles $oralce --seed $seed --run_name reinvent_0k --config_default hparams_default.yaml --wandb online 
done
done
...
do
# echo $oralce
taskset -c 0-11 python run.py ngo --oracles $oralce --seed $seed --run_name molga_reinvent_0k --config_default hparams_molga.yaml --wandb online --patience 100
done
done